...
float approx(float v) {
    float value = abs(v);
    //0.0005\left(-1.\times10^{7}x+632.456\sqrt{2.5\times10^{8}x^{2}-1.01047\times10^{10}x+2.06588\times10^{11}}+2.02094\times10^{8}\right)^{\frac{1}{3}}-\frac{173.516}{\left(-1.\times10^{7}x+632.456\sqrt{2.5\times10^{8}x^{2}-1.01047\times10^{10}x+2.06588\times10^{11}}+2.02094\times10^{8}\right)^{\frac{1}{3}}}+1.5185
    //0.0005\left(-1.\times10^{7}x+632.456\sqrt{2.5\times10^{8}x^{2}-1.01047\times10^{10}x+2.06588\times10^{11}}+2.02094\times10^{8}\right)^{\frac{1}{3}}-\frac{173.516}{\left(-1.\times10^{7}x+632.456\sqrt{2.5\times10^{8}x^{2}-1.01047\times10^{10}x+2.06588\times10^{11}}+2.02094\times10^{8}\right)^{\frac{1}{3}}}+1.5185
    return 0.0005 * pow((-1.0e7 * value + 632.456 * sqrt(2.5e8 * value * value - 1.01047e10 * value + 2.06588e11)) + 2.02094e8, 1.0 / 3.0) - (173.516 / pow(-1.0e7 * value + 632.456 * sqrt(2.5e8 * value * value - 1.01047e10 * value + 2.06588e11) + 2.02094e8, 1.0 / 3.0)) + 1.5185;
}

float cubert(float v) {
...
void main() {
    ...
    color = wavelengthToRGB(iorToWavelength(approx(degrees(angle))));
    
    // color = wavelengthToRGB(iorToWavelength(radiansToIOR(angle)));
    // color = wavelengthToRGB(mapRange(radiansToIOR(angle), 1.33141, 1.34451, 700.0, 400.0));
    // color = vec4(vec3(radiansToIOR(angle)), 1.0);
    // color = vec4(vec3(approx(1.0)), 1.0);
    
    // color = vec4(vec3((snoise(uv * 10000.0) + 1.0) / 2.0), 1.0);
    // color = vec4(wavelengthToRGB(mapRange(approx(degrees(yaw)), 1.33141, 1.34451, 400.0, 700.0)).xyz, 1.0);

    // color = vec4(wavelengthToRGB(mapRange(uv.x, 0.0, 1.0, 380.0, 780.0)), 1.0);
